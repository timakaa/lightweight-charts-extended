// useLongPositionChartEvents.js - React hook for handling chart click and crosshair move events for long positions
import { useEffect } from "react";
import { TOOL_CROSSHAIR } from "../../store/tool";
import { isPointOnLongPosition } from "../../drawing-tools/long-position/helpers";
...
// Handles subscribing/unsubscribing to chart click and crosshair move events for long positions
function useLongPositionChartEvents(
  chart,
  candlestickSeries,
  currentToolRef,
  positionsDataRef,
  ...
  useEffect(() => {
    ...
    const handleCrosshairMove = (param) => {
      ...
      for (const pos of positionsDataRef.current) {
        if (
          isPointOnLongPosition(logicalPoint, pos, chart, candlestickSeries)
        ) {
          hoveredPosition = pos;
          break;
        }
...
export default useLongPositionChartEvents;
