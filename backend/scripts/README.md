...
docker-compose exec backend python scripts/scraper/ccxt_scraper.py --symbol ETHUSDT --timeframe 4h --start 2023-01-01

# Multiple symbols and timeframes
docker-compose exec backend python scripts/scraper/ccxt_scraper.py --symbol BTCUSDT,ETHUSDT --timeframe 1h,4h,1d

# Different exchange
docker-compose exec backend python scripts/scraper/ccxt_scraper.py --symbol BTCUSDT --exchange binance
```
...
docker-compose exec backend python scripts/scraper/ccxt_scraper.py --symbol BTCUSDT --start 2024-01-01 --end 2024-12-31

# Scrape multiple symbols and timeframes
docker-compose exec backend python scripts/scraper/ccxt_scraper.py --symbol BTCUSDT,ETHUSDT,SOLUSDT --timeframe 1h,4h

# First scrape data, then run backtest
docker-compose exec backend python scripts/scraper/ccxt_scraper.py --symbol ETHUSDT --timeframe 1h
